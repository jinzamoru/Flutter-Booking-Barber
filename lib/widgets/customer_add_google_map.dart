...
class CustomerAddMap extends StatefulWidget {
  final LocationInfo cuslocation;
  @override
  State<CustomerAddMap> createState() => CustomerAddMapState();

  const CustomerAddMap({
    super.key,
    required this.cuslocation,
  });
}

class CustomerAddMapState extends State<CustomerAddMap> {
      ...
      bottomNavigationBar: Container(
        ...
        child: MaterialButton(
          onPressed: () async {
            ...
            await addLocation(locationModel, context);
          },
