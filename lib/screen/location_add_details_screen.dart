...
import '../widgets/customer_add_google_map.dart';

class LocationAddDetailScreen extends StatefulWidget {
  final String id;

  const LocationAddDetailScreen({super.key, required this.id});
        ...
        child: MaterialButton(
          onPressed: () async {
            ...
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => CustomerAddMap(
