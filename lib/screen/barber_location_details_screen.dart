...
import '../widgets/barber_pleace_auto.dart';

class BaberLocationDetailScreen extends StatefulWidget {
    final BarberInfo model;

 const BaberLocationDetailScreen({
    super.key,
    required this.model,
  });
  ...
  _BaberLocationDetailScreenState createState() => _BaberLocationDetailScreenState();
}

class _BaberLocationDetailScreenState extends State<BaberLocationDetailScreen> {
                            ...
                            child: GoogleMap(
                              ...
                              onTap: (position) {
                                Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) =>
                                            BarberPlaceAutocompleteWidget(
                                                barberlocation: model)));
                              },
                            ),
                          ),
